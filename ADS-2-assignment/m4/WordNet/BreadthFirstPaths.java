 ...
 *  Data files:   https://algs4.cs.princeton.edu/41Digraph/tinyCG.txt
 *                https://algs4.cs.princeton.edu/41Digraph/tinyG.txt
 *                https://algs4.cs.princeton.edu/41Digraph/mediumG.txt
 *                https://algs4.cs.princeton.edu/41Digraph/largeG.txt
 *
 *  Run breadth first search on an undirected Digraph.
 *  Runs in O(E + V) time.
 *
 ...
 *  to every other vertex in an undirected Digraph.
 *  <p>
 ...
 *  see <a href="https://algs4.cs.princeton.edu/41Digraph">Section 4.1</a>
...
public class BreadthFirstPaths {
     ...
     * and every other vertex in Digraph {@code G}.
     * @param G the Digraph
