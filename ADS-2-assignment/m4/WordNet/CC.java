 ...
 *  Dependencies: Digraph.java StdOut.java Queue.java
 *  Data files:   https://algs4.cs.princeton.edu/41Digraph/tinyG.txt
 *                https://algs4.cs.princeton.edu/41Digraph/mediumG.txt
 *                https://algs4.cs.princeton.edu/41Digraph/largeG.txt
 *
 ...
 *  determining the connected components in an undirected Digraph.
 ...
 *  <p>
 *  For additional documentation, see <a href="https://algs4.cs.princeton.edu/41Digraph">Section 4.1</a>
...
public class CC {
    ...
    /**
     * Computes the connected components of the undirected Digraph {@code G}.
     *
     * @param G the undirected Digraph
     */
    public CC(Digraph G) {
    ...
    /**
     * Computes the connected components of the edge-weighted Digraph {@code G}.
     *
    ...
    /**
     * Returns the number of connected components in the Digraph {@code G}.
     *
     * @return the number of connected components in the Digraph {@code G}
     */
    public int count() {
        return count;
    }
